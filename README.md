# Cross-platform mouse scroll wheel acceleration, implemented in user space
...
I just want to have that support now, on my desktop (mostly Linux).
...
Unfortunately, official scroll acceleration is not supported yet in other desktop operating systems
despite Mac
(Linux or Windows)
